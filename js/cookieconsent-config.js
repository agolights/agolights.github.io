...
CookieConsent.run({
    ...
    onChange: ({changedCategories, changedServices}) => {
		...
		if(changedCategories.includes('analytics')){
            ...
            if(CookieConsent.acceptedCategory('analytics')){
                console.log("analytics : change-enabled");
				gtag('consent', 'update', {
					ad_storage: 'granted',
					analytics_storage: 'granted'
				});
            }else{
                console.log("analytics : change-disabled");
				gtag('consent', 'update', {
					ad_storage: 'denied',
					analytics_storage: 'denied'
				});
    ...
    language: {
        ...
        translations: {
            fr: {
                consentModal: {
                    title: "<div class=\"align-center text-center\"><img src=\"images/Agolights_alpha_HD.png\" class=\"img-responsive align-center\" style=\"width:auto;height:40px\"></div> </br></br>Ce site utilise des cookies",
                    description: "Pour son fonctionnement et à des fin d'amélioration, ce site utilise des cookie. Vous pouvez modifier votre consentement à tout moment depuis la page « Politique de confidentialité ».</br><a data-cc=\"accept-necessary\" href=\"#\" class=\"text-link\">Continuer sans accepter</a>",
                ...
                preferencesModal: {
                    ...
                    acceptAllBtn: "Accepter tout",
                    acceptNecessaryBtn: "Ne pas accepter",
                    ...
                    sections: [
                        {
                            ...
                            description: "Cette page vous permet de comprendre l'utilisation des cookies sur ce site web et de personnaliser l'activation des cookies non-strictement nécessaires."
                        },
                        {
                            title: "Cookies Strictement Nécessaires <span class=\"pm__badge\">Toujours Activé</span>",
                            description: "Les cookies permettent le bon fonctionnement du site web.",
                            linkedCategory: "necessary"
                        },
                        {
                            title: "Google Analytics GA4",
                            description: "Ces cookies permettent la mesure d'audience et la récupération de statistiques anonymisées à des fins d'amélioration du site web.",
                            linkedCategory: "analytics"
                        },
                        {
                            title: "Plus d'informations",
                            description: "Pour plus d'informations au sujet des cookies et de leur utilisation, veuillez vous réferer à la <a class=\"cc__link\" href=\"legal\">politique de confidentialité</a>."
                        }
                    ]
                }
            }
